<template>
    <div style="text-align: center ;height:95vh; width: 100%;">
        <div style="height: 90vh">
            <v-row style=" width:80vw;"><span style="text-align:center; font-weight:900 ;">Tax Invoice</span></v-row>
            <v-divider style=" width:80vw;"></v-divider>
            <table style="width:80vw; border: white">
            ...
            <v-divider class="black" style="width:80vw;"></v-divider>
            <table style="width:80vw; border: white;">
                <tr>
                    <td style=" border: white; font-weight:500">Buyer: (Bill To)</td>
                ...
                <tr>
                    <td style=" border: white; font-weight:900">Sambhav</td>
                    <td style="font-weight:900; border: white;">Order ID:</td>
                    <td style="text-align:right; border: white; font-weight:500"> zdfCNOdfwZT9qfKPRj8u</td>
                </tr>
                <tr>
                    <td style=" border: white; font-weight:500">State: NCT of Delhi</td>
                ...
                <tr>
                    <td style=" border: white; font-weight:500">State Code: 7</td>
            ...
            <table style="width:80vw; margin-top: 10px; margin-bottom: 0px;">
                <tr style="">
            ...
            <table style="width:80vw; margin-bottom: 10px;">
                <tr>
            ...
            <table style="width:80vw;  margin-top: 10px;">
                <tr>
            ...
            <table style="width:80vw;  margin-bottom: 10px;">
                ...
                <tr style="height:5vh">
                    <td style="margin-top:0px; height: 5vh; text-align: left; border-top:white; font-weight:500">Declaration: 
                    ...
                    <td style="height:5vh; text-align:center; border-top:white; font-weight:500">
            ...
            <v-divider style=" width:80vw;"></v-divider>
            <v-row style=" width:80vw; text-align: center; font-weight:500">SUBJECT TO DELHI JURISDICTION</v-row>
            <v-row style=" width:80vw; text-align: center; font-weight:500">This is a Computer Generated Invoice
            </v-row>
        </div>
    </div>
</template>

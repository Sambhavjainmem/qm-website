<template>
  <div class="home" id="refhome">
      ...
      <div id="bgcolor">
        ...
        >
          ...
          <div
            ...
            "
          >
            We will get you the best prices for the services we offer for your
            car
          </div>
        </div>
      </div>

      <div class="bgtext">QUICK MECHANIC</div>
      ...
      <div id="middle">
        <div id="chip">
          <div id="svechile">
            <v-container
              fluid
              style="color: red; height: fit-content; width: fit-content"
            >
    ...
    <div class="footer">
      <span class="subfooter">We are in Social</span>
      <div class="subfooter">
...
export default {
  ...
  methods: {
    ...
    onChange() {
      (this.caritems = []), this.carmodel(this.$store.state.vinfo.brand);
